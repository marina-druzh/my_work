...
# 	age, gender, height, weight, ap_hi, ap_lo, cholesterol, gluc, smoke, alco, active_a = ""
	...
	print(pd.DataFrame({"age_years": [age], 'gender': [gender], 'height': [height], 'weight': [weight], 'ap_hi': [ap_hi],
				  'ap_lo': [ap_lo], 'cholesterol': [cholesterol], 'gluc': [gluc], 'smoke': [smoke], 'alco': [alco],
				  'active': [active]}))
	preds = model.predict_proba(pd.DataFrame({"age_years": [age], 'gender': [gender], 'height': [height], 'weight': [weight], 'ap_hi': [ap_hi],
	 	 'ap_lo': [ap_lo], 'cholesterol': [cholesterol], 'gluc': [gluc], 'smoke': [smoke], 'alco': [alco], 'active': [active]}))
...
if __name__ == "__main__":
	...
	modelpath = "Catboost_pipeline.pkl"
